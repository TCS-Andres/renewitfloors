  ...
  return (
    <>
      ...
      <section className="bg-[var(--color-ink)] text-white">
        <Container>
          <div className="grid items-center gap-12 py-20 md:grid-cols-2 md:py-28 md:gap-16">
            <Reveal>
              <Eyebrow tone="rust" className="block mb-5">
                Our Method
              </Eyebrow>
              <h2 className="font-display text-[36px] font-bold leading-[1.05] tracking-[-0.025em] text-white md:text-[52px]">
        ...
        <Container>
          <div className="text-center">
            <Reveal>
              ...
              <h2 className="mx-auto max-w-3xl font-display text-[36px] font-bold leading-[1.05] tracking-[-0.025em] text-[var(--color-charcoal)] md:text-[48px]">
