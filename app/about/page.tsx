      ...
      <section className="bg-[var(--color-ink)] text-white" id="method">
        <Container>
          <div className="py-24 md:py-36">
            ...
            <Reveal delay={0.1}>
              <h2 className="max-w-4xl font-display text-[40px] font-bold leading-[1.05] tracking-[-0.025em] text-white md:text-[64px]">
      ...
      <Section tone="cream" padded>
        <Container>
          <Reveal>
            ...
            <h2 className="max-w-3xl font-display text-[40px] font-bold leading-[1.05] tracking-[-0.025em] text-[var(--color-charcoal)] md:text-[56px]">
      ...
      <Section tone="white" padded>
        <Container size="narrow">
          <Reveal className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-3xl font-display text-[34px] font-bold leading-[1.15] tracking-[-0.025em] text-[var(--color-charcoal)] md:text-[48px]">
